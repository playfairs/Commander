...
extension MainWindowController: NSToolbarDelegate {
  ...
  func toolbar(
    ...
    case .reveal:
      return toolbarItem(
        identifier: .reveal,
        image: NSImage(systemSymbolName: "folder", accessibilityDescription: "Reveal"),
        label: "Reveal")
    case .viewList:
      return toolbarItem(
        identifier: .viewList,
        image: NSImage(systemSymbolName: "list.bullet", accessibilityDescription: "List"),
        label: "List")
    case .viewGrid:
      return toolbarItem(
        identifier: .viewGrid,
        image: NSImage(systemSymbolName: "square.grid.2x2", accessibilityDescription: "Grid"),
        label: "Grid")
    case .info:
      return toolbarItem(
        identifier: .info,
  ...
  private func toolbarItem(identifier: NSToolbarItem.Identifier, image: NSImage?, label: String)
    -> NSToolbarItem
  {
